...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getSensors() {
                return [
                    { id: "fd002124b00a4a5a", latlng: [50.94099679, -0.10949393] },
                    { id: "node_2", latlng: [50.94131024, -0.10934176] },
                    { id: "node_3", latlng: [50.94171482, -0.10913786] },
                    { id: "node_4", latlng: [50.94219203, -0.10916078] },
                    { id: "node_5", latlng: [50.94236324, -0.10900667] },
                    { id: "node_6", latlng: [50.9410758, -0.11020363] },
                    { id: "node_7", latlng: [50.9413209, -0.11009397] },
                    { id: "node_8", latlng: [50.94182848, -0.10997704] },
                    { id: "node_9", latlng: [50.94208887, -0.10993387] },
                    { id: "node_10", latlng: [50.94250863, -0.10991221] },
                    { id: "node_11", latlng: [50.9424186, -0.10866688] },
                    { id: "node_12", latlng: [50.94199277, -0.10867638] },
                    { id: "node_13", latlng: [50.94164463, -0.10886622] },
                    { id: "node_14", latlng: [50.94126736, -0.10890052] },
                    { id: "node_15", latlng: [50.94096022, -0.10925082] },
                    { id: "node_16", latlng: [50.94089209, -0.10990126] },
                    { id: "node_17", latlng: [50.94133561, -0.10969257] },
                    { id: "node_18", latlng: [50.94209916, -0.10953461] },
                    { id: "node_19", latlng: [50.94172002, -0.10957757] },
                    { id: "node_20", latlng: [50.94244257, -0.10942202] },
                    { id: "node_21", latlng: [50.94104064, -0.11057843] },
                    { id: "node_22", latlng: [50.94148519, -0.11033065] },
                    { id: "node_23", latlng: [50.94177094, -0.11037551] },
                    { id: "node_24", latlng: [50.94216666, -0.11023289] },
                    { id: "node_25", latlng: [50.94232998, -0.1103066] },
                    { id: "node_26", latlng: [50.942387, -0.10990188] }
                ];
            },
            getSensorsData() {
                return [
